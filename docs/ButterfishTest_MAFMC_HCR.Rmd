...
# OM$input$data$selblock_pointer_fleets has selectivity years for fishery
...
Fixed the error above and a susequent one for index_paa_pars by adding the matrices in lines 535-536
